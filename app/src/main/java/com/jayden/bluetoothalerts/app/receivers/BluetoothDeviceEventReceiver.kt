        ...
        when (intent.action) {
            BluetoothDevice.ACTION_ACL_CONNECTED -> {
                ...
                AppNotificationManager.showBluetoothAclConnectedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_ACL_CONNECTED_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_ACL_DISCONNECT_REQUESTED -> {
                ...
                AppNotificationManager.showBluetoothAclDisconnectRequestedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_ACL_DISCONNECT_REQUESTED_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_ACL_DISCONNECTED -> {
                ...
                AppNotificationManager.showBluetoothAclDisconnectedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_ACL_DISCONNECTED_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_ALIAS_CHANGED -> {
                ...
                AppNotificationManager.showBluetoothAliasChangedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_ALIAS_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_BOND_STATE_CHANGED -> {
                ...
                val deviceBondState =
                    AppNotificationManager.BluetoothBondState.fromId(bluetoothBondState)!!
                ...
                AppNotificationManager.showBluetoothBondStateChangedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_BOND_STATE_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_CLASS_CHANGED -> {
                ...
                AppNotificationManager.showBluetoothClassChangedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_CLASS_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_ENCRYPTION_CHANGE -> {
                ...
                AppNotificationManager.showBluetoothEncryptionChangedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_ENCRYPTION_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
                    ...
                    keySize * 8,
                    AppNotificationManager.BluetoothDeviceEncryptionAlgorithm.fromId(
                        encryptionAlgorithm
                    )!!
                )
            }
            ...
            BluetoothDevice.ACTION_FOUND -> {
                ...
                AppNotificationManager.showBluetoothDeviceFoundNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_FOUND_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_KEY_MISSING -> {
                ...
                val bluetoothBondLossReason =
                    if (Build.VERSION.SDK_INT_FULL >= Build.VERSION_CODES_FULL.BAKLAVA_1) {
                        intent.getIntExtra(
                            BluetoothDevice.EXTRA_BOND_LOSS_REASON,
                            BluetoothDevice.ERROR
                        )
                    } else null
                ...
                AppNotificationManager.showBluetoothKeyMissingNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_MISSING_KEY_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
                    bluetoothBondLossReason?.let {
                        AppNotificationManager.BluetoothBondLossReason.fromId(
                            it
                        )
                    }
                )
            ...
            BluetoothDevice.ACTION_NAME_CHANGED -> {
                ...
                AppNotificationManager.showBluetoothNameChangedNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_NAME_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName
            ...
            BluetoothDevice.ACTION_PAIRING_REQUEST -> {
                ...
                AppNotificationManager.showBluetoothPairingRequestNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_PAIRING_REQUEST_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
            ...
            BluetoothDevice.ACTION_UUID -> {
                ...
                AppNotificationManager.showBluetoothUuidNotification(
                    context,
                    AppNotificationManager.BLUETOOTH_UUID_NOTIFY_ID + deviceAddress.hashCode() + deviceName.let {
                        it?.hashCode() ?: 0
                    },
                    deviceAddress,
                    deviceName,
